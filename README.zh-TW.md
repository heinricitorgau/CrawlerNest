...
- **多來源排名** — 1,499 所大學，三個來源實際匯入：QS 1,499 筆、THE 1,080 筆、ARWU 686 筆
...
|---|---:|---:|---|
| QS + THE + ARWU | 573 | 1.000 | high |
| QS + THE | 507 | 0.876 | medium |
| QS + ARWU | 113 | 0.346 | medium |
| 僅 QS | 306 | 0.222 | low |
...
- 三個排名來源都已匯入：QS 1,499 筆、THE 1,080 筆、ARWU 686 筆
- 573 所大學達到三來源（信心 high），306 所仍為單一來源（low）
- 實體解析的覆蓋率仍有缺口：THE 有 419 所、ARWU 有 291 筆未配對。規則能安全處理
