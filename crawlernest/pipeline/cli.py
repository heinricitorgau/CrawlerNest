...
def build_parser(
    ...
    *,
    ...
    rebuild_preview_and_resolve_parser = subparsers.add_parser(
        ...
        help="Write admission landing rows and refresh admission entity resolution in sequence",
    )
    ...
    decision_ranking_preview_parser = subparsers.add_parser(
        ...
        help="Build decision-layer preview rows from the published analytics aggregation",
    )
    decision_ranking_preview_parser.add_argument(
        "--source-schema",
        default="analytics",
        help="Schema containing the aggregated ranking source table",
    )
    decision_ranking_preview_parser.add_argument(
        "--source-table",
        default="aggregated_rankings",
