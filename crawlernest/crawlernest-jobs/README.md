...
- `qs_universe_crawlers.py`, `the_crawler.py`, `arwu_crawler.py`: existing source-specific crawl implementations that should gradually be wrapped or migrated behind `crawlernest-ranking-crawler/`.

## Boundary

- shared transport/runtime concerns belong in `crawlernest-crawler-core/`
- ranking-source crawling belongs in `crawlernest-ranking-crawler/`
