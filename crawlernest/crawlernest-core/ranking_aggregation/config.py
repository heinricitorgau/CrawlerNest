...
class AggregationConfig:
    ...
    - composite_score is retained for display only and must not drive rank order
    """

    aggregation_method_version: str = "rank_agg_v2"
...
def default_aggregation_config() -> AggregationConfig:
    return AggregationConfig(
        aggregation_method_version="rank_agg_v2",
        source_weights={
            "QS": 0.40,
            "THE": 0.35,
            "ARWU": 0.25,
