...
- [MAINTENANCE_DISCIPLINE.md](MAINTENANCE_DISCIPLINE.md) — general healthy/unhealthy patterns
- [MAINTENANCE_CONTINUITY_MODEL.md](MAINTENANCE_CONTINUITY_MODEL.md) — stable degraded continuity definition
