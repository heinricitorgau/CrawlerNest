...
- [ANALYTICS_VISUALIZATION_PLAN.md](ANALYTICS_VISUALIZATION_PLAN.md) — visualization decisions
- [RECOMMENDATION_EVIDENCE_MODEL.md](RECOMMENDATION_EVIDENCE_MODEL.md) — evidence API contract
