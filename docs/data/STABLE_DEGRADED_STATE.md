...
See also:
- [OPERATIONAL_MEMORY_PRESERVATION.md](../operational/OPERATIONAL_MEMORY_PRESERVATION.md) — memory semantics
- [MAINTENANCE_DISCIPLINE.md](../operational/MAINTENANCE_DISCIPLINE.md) — healthy response to known degraded state
- [OPERATIONAL_CALMNESS_REVIEW.md](../operational/OPERATIONAL_CALMNESS_REVIEW.md) — false urgency analysis
