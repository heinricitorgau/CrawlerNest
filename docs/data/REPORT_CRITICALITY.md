...
- [MAINTENANCE_SIGNAL_CLARITY.md](../operational/MAINTENANCE_SIGNAL_CLARITY.md) — signal class definitions
- [OPERATIONAL_RESTRAINT_GUIDELINES.md](../operational/OPERATIONAL_RESTRAINT_GUIDELINES.md) — criteria before adding a new report
