...
See also:
- [REPORT_CRITICALITY.md](../data/REPORT_CRITICALITY.md) — criticality classification
- [OPERATIONAL_RESTRAINT_GUIDELINES.md](../operational/OPERATIONAL_RESTRAINT_GUIDELINES.md) — when not to add artifacts
